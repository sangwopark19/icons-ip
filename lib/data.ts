...
const IPS: Ip[] = [
  { id: 'hwasan', title: '화산강림', sub: '리디 · 로판', v: V.rofan, glyph: '화산\n강림', bg: grad('#3a1d6e', '#8B5CFF', '#FF4D9D'), fans: 42130, goods: 38, cards: 24, featured: true,
    tagline: '백번 죽어도 화산의 검을 든다', synopsis: '정파의 자존심 화산파, 그 부활을 그린 무협 판타지. 공식 라이선스 굿즈와 한정 카드가 ICONS에서 처음 공개됩니다.' },
  { id: 'cheong', title: '청명', sub: '카카오웹툰 · 로판', v: V.rofan, glyph: '청명', bg: grad('#1d2f6e', '#2D6FDB', '#8B5CFF'), fans: 31980, goods: 22, cards: 18, featured: true,
    tagline: '매화는 다시 핀다', synopsis: '청명 매화 시리즈 공식 굿즈 라인. 향수 한정판부터 아크릴까지.' },
  { id: 'lumen', title: 'LUMEN', sub: 'Global Anime', v: V.global, glyph: 'LU\nMEN', bg: grad('#0c4a5e', '#2DE2FF', '#38F0C0'), fans: 89020, goods: 54, cards: 40, featured: true,
    tagline: 'The light never sleeps', synopsis: '글로벌 흥행 애니메이션 LUMEN의 한국 공식 파트너. 시즌 한정 컬렉션 진행 중.' },
  { id: 'nocturne', title: '녹턴 클럽', sub: 'BL · 오리지널', v: V.blgl, glyph: '녹턴\n클럽', bg: grad('#5e0c3a', '#FF4D9D', '#8B5CFF'), fans: 28470, goods: 30, cards: 21, featured: false,
    tagline: '밤은 우리 편', synopsis: '밴드 BL 「녹턴 클럽」 공식 머천다이즈.' },
  { id: 'lilac', title: '라일락 노트', sub: 'GL · 학원', v: V.blgl, glyph: '라일락', bg: grad('#3a0c5e', '#A981FF', '#FF4D9D'), fans: 19340, goods: 16, cards: 14, featured: false,
    tagline: '다정도 병이라면', synopsis: 'GL 감성 학원물 공식 컬렉션.' },
  { id: 'hoshina', title: '호시나 미오', sub: 'VTuber', v: V.vtuber, glyph: '호시나\n미오', bg: grad('#0c5e4a', '#38F0C0', '#2DE2FF'), fans: 35180, goods: 44, cards: 33, featured: true,
    tagline: '오늘도 별을 줍는 중', synopsis: '버튜버 호시나 미오 1주년 기념 한정 굿즈 & 생일 카드 드롭.' },
  { id: 'rune', title: 'RUNE Live', sub: 'Streamer', v: V.streamer, glyph: 'RUNE', bg: grad('#5e3a0c', '#FFB23D', '#FF4D9D'), fans: 24760, goods: 19, cards: 16, featured: false,
    tagline: '클립 장인', synopsis: '스트리머 RUNE 공식 채널 굿즈.' },
  { id: 'aster', title: 'ASTER', sub: 'Global · Game', v: V.global, glyph: 'AS\nTER', bg: grad('#1d1d6e', '#5B7BFF', '#2DE2FF'), fans: 51200, goods: 48, cards: 36, featured: false,
...
const GOODS: Good[] = [
  { id: 'g1', name: '청명 매화 향수 한정판', ip: 'cheong', type: '음원·앨범', price: 38000, badge: '한정', stock: 'low', img: grad('#1d2f6e', '#2D6FDB', '#8B5CFF') },
  { id: 'g2', name: '화산강림 청명 아크릴 스탠드', ip: 'hwasan', type: '아크릴 스탠드', price: 22000, badge: '신상', stock: 'ok', img: grad('#3a1d6e', '#8B5CFF', '#FF4D9D') },
  { id: 'g3', name: '호시나 미오 1st 포토카드 세트', ip: 'hoshina', type: '포토카드', price: 15000, badge: '한정', stock: 'low', img: grad('#0c5e4a', '#38F0C0', '#2DE2FF') },
  { id: 'g4', name: 'LUMEN 시즌2 피규어', ip: 'lumen', type: '피규어', price: 89000, badge: '예약', stock: 'ok', img: grad('#0c4a5e', '#2DE2FF', '#38F0C0') },
  { id: 'g5', name: '녹턴 클럽 멤버 키링 6종', ip: 'nocturne', type: '키링', price: 12000, badge: null, stock: 'ok', img: grad('#5e0c3a', '#FF4D9D', '#8B5CFF') },
  { id: 'g6', name: 'ASTER 콜렉터 박스 세트', ip: 'aster', type: '한정 세트', price: 74000, badge: '한정', stock: 'soldout', img: grad('#1d1d6e', '#5B7BFF', '#2DE2FF') },
  { id: 'g7', name: '라일락 노트 엽서북', ip: 'lilac', type: '문구', price: 9000, badge: null, stock: 'ok', img: grad('#3a0c5e', '#A981FF', '#FF4D9D') },
  { id: 'g8', name: 'RUNE 오버사이즈 후드', ip: 'rune', type: '의류', price: 54000, badge: '신상', stock: 'ok', img: grad('#5e3a0c', '#FFB23D', '#FF4D9D') },
  { id: 'g9', name: '화산강림 매화검 레플리카', ip: 'hwasan', type: '한정 세트', price: 128000, badge: '한정', stock: 'low', img: grad('#2a1550', '#8B5CFF', '#2DE2FF') },
  { id: 'g10', name: '호시나 미오 아크릴 디오라마', ip: 'hoshina', type: '아크릴 스탠드', price: 34000, badge: null, stock: 'ok', img: grad('#0c5e5e', '#38F0C0', '#8B5CFF') },
  { id: 'g11', name: 'LUMEN 홀로그램 포토카드 12종', ip: 'lumen', type: '포토카드', price: 18000, badge: '한정', stock: 'low', img: grad('#0c3a5e', '#2DE2FF', '#A981FF') },
...
const CARDS: Card[] = [
  ...
  { id: 'c2', ip: 'hwasan', name: '화산의 검', no: '014/120', rarity: 'SSR', owned: true, bg: grad('#2a1550', '#8B5CFF', '#2DE2FF') },
  { id: 'c3', ip: 'hoshina', name: '호시나 · 1주년', no: '003/088', rarity: 'SSR', owned: true, bg: grad('#0c5e4a', '#38F0C0', '#2DE2FF') },
  { id: 'c4', ip: 'lumen', name: 'LUMEN · Dawn', no: '027/200', rarity: 'SR', owned: true, bg: grad('#0c4a5e', '#2DE2FF', '#38F0C0') },
  { id: 'c5', ip: 'cheong', name: '청명 · 봄밤', no: '041/090', rarity: 'R', owned: true, bg: grad('#1d2f6e', '#2D6FDB', '#8B5CFF') },
  { id: 'c6', ip: 'nocturne', name: '녹턴 · 무대', no: '009/070', rarity: 'SR', owned: true, bg: grad('#5e0c3a', '#FF4D9D', '#8B5CFF') },
  { id: 'c7', ip: 'hwasan', name: '청명 · 입문', no: '072/120', rarity: 'N', owned: true, bg: grad('#241640', '#5a4a8a', '#8B5CFF') },
  { id: 'c8', ip: 'lumen', name: 'LUMEN · Eclipse', no: '112/200', rarity: 'SSR', owned: false, bg: grad('#0c3a5e', '#2DE2FF', '#A981FF') },
  { id: 'c9', ip: 'hoshina', name: '호시나 · 스타라이트', no: '055/088', rarity: 'HOLO', owned: false, bg: grad('#0c5e5e', '#38F0C0', '#8B5CFF') },
  { id: 'c10', ip: 'aster', name: 'ASTER · Nova', no: '088/150', rarity: 'SR', owned: false, bg: grad('#1d1d6e', '#5B7BFF', '#2DE2FF') },
  { id: 'c11', ip: 'lilac', name: '라일락 · 방과후', no: '033/060', rarity: 'R', owned: false, bg: grad('#3a0c5e', '#A981FF', '#FF4D9D') },
  { id: 'c12', ip: 'rune', name: 'RUNE · 클러치', no: '019/070', rarity: 'SR', owned: false, bg: grad('#5e3a0c', '#FFB23D', '#FF4D9D') },
];
